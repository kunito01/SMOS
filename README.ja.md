...
- **PWA と国際化 UI** — GitHub Pages/PWA 配布、レスポンシブナビゲーションとモーダル、長文表示を改善し、11 の正式 UI 言語に加えて 12 番目の娯楽用シュメール楔形文字を追加しました。
...
| デスクトップ、タブレット、狭幅モバイル対応レイアウト | インストール可能な PWA、オフラインフォールバック、12 の言語オプション |
...
- **多言語インターフェース** — 英語、簡体字中国語、日本語、スペイン語、ポルトガル語、ドイツ語、フランス語、ロシア語、トルコ語、韓国語、タイ語、および学術用途ではない娯楽版シュメール楔形文字を利用できます。
...
インターフェースには 12 の言語オプションがあります。シュメール楔形文字は意図的な娯楽用の疑似翻訳で、安全に関わる文言には英語を併記し、日付・数値・通貨・記号は英語オプションと同じ形式および通常のラテン UI フォントを使用します。学術用途を意図したものではありません。その他のロケールは専用キーがない場合に英語へフォールバックします。
