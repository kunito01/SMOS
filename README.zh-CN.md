...
- **PWA 与国际化界面**：完善 GitHub Pages/PWA 发布、响应式导航和弹窗、长文本处理，同步十一种正式界面语言，并加入第十二种娱乐版苏美尔楔形文字选项。
...
| 桌面、平板与窄屏移动端布局 | 可安装 PWA、离线回退与十二种界面语言选项 |
...
- **多语言界面**：支持英语、简体中文、日语、西班牙语、葡萄牙语、德语、法语、俄语、土耳其语、韩语、泰语，以及明确不具学术性质的娱乐版苏美尔楔形文字。
...
界面现提供十二种语言选项。苏美尔楔形文字是刻意设计的娱乐性伪翻译：涉及安全的文案会保留英文说明，日期、数字、金额和符号沿用英语选项相同的格式及常规拉丁界面字体；它不用于学术场景。其他语种缺少专用翻译键时会回退到英文，当前俄语和土耳其语词典已覆盖全部翻译键。
