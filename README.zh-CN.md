...
<p align="center">
  <a href="./README.md">English</a> · <strong>简体中文</strong> · 日本語 · Español · Português · Deutsch · Français · 한국어 · ไทย
</p>
...
| 桌面、平板与窄屏移动端布局 | 可安装 PWA、离线回退与九种界面语言 |
...
- **多语言界面**：支持英语、简体中文、日语、西班牙语、葡萄牙语、德语、法语、韩语和泰语。
...
英语和简体中文是主要字典。其他语言会在缺少专用翻译时回退到英文，以保证界面不会出现空白文案。欢迎通过 Issue 或 Pull Request 改进翻译覆盖与措辞质量。
