...
<p align="center">
  <strong>English</strong> · <a href="./README.zh-CN.md">简体中文</a> · 日本語 · Español · Português · Deutsch · Français · 한국어 · ไทย
</p>
...
| Desktop, tablet, and narrow-mobile layouts | Installable PWA, offline fallback, and nine interface languages |
...
- **International interface** — use English, Simplified Chinese, Japanese, Spanish, Portuguese, German, French, Korean, or Thai.
...
English and Simplified Chinese are the primary dictionaries. Other languages fall back to English for keys without a dedicated translation, ensuring that interface text remains available. Translation coverage and wording improvements are welcome through Issues and Pull Requests.
