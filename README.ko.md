...
- **PWA 및 다국어 UI** — GitHub Pages/PWA 배포, 반응형 탐색과 모달, 긴 문장 표시를 개선하고 11개 정식 언어에 12번째 오락용 수메르 쐐기문자 옵션을 추가했습니다.
...
| 데스크톱, 태블릿, 좁은 모바일 화면용 레이아웃 | 설치 가능한 PWA, 오프라인 대체 화면, 12개 언어 옵션 |
...
- **다국어 인터페이스** — 영어, 중국어 간체, 일본어, 스페인어, 포르투갈어, 독일어, 프랑스어, 러시아어, 튀르키예어, 한국어, 태국어와 학술용이 아닌 오락용 수메르 쐐기문자를 사용할 수 있습니다.
...
인터페이스는 12개 언어 옵션을 제공합니다. 수메르 쐐기문자는 의도적으로 만든 오락용 의사 번역이며, 안전 관련 문구에는 영어 안내를 유지하고 날짜·숫자·통화·기호는 영어 옵션과 같은 형식 및 일반 라틴 UI 글꼴을 사용합니다. 학술용 번역이 아닙니다. 다른 로케일은 전용 키가 없으면 영어로 대체됩니다.
